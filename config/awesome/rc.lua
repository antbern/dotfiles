...
-- I want to use fish as my default shell without actually setting is as the shell
...
clientbuttons = gears.table.join(
	...
	-- Extra binding for resizing using touchpad, where right clicking and dragging is cumbersome
